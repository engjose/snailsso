...
public interface UserMapper {
    ...
    @Select({
        "select",
        "`id`, `user_name`, `identity_card_type`, `identity_card_no`, `mobile`, `email`, ",
        "`gender`, `point`, `register_time`, `birthday`, `user_level`, `account_money`, ",
        "`create_time`, `update_time`, `app`, `status`",
        "from `user`",
        "where `id` = #{id,jdbcType=INTEGER}"
    })
