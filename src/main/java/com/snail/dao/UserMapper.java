...
import com.snail.pojo.domain.UserKey;
...
public interface UserMapper {
    ...
    @Insert({
        ...
        "`user_name`, `identity_card_type`, ",
        "`identity_card_no`, `mobile`, ",
        "`email`, `gender`, `point`, ",
        "`register_time`, `birthday`, ",
        "`user_level`, `account_money`, ",
        "`create_time`, `update_time`, ",
        "`app`)",
        "values (#{id,jdbcType=INTEGER}, #{status,jdbcType=INTEGER}, ",
        "#{userName,jdbcType=VARCHAR}, #{identityCardType,jdbcType=INTEGER}, ",
        "#{identityCardNo,jdbcType=VARCHAR}, #{mobile,jdbcType=VARCHAR}, ",
        "#{email,jdbcType=VARCHAR}, #{gender,jdbcType=CHAR}, #{point,jdbcType=INTEGER}, ",
        "#{registerTime,jdbcType=TIMESTAMP}, #{birthday,jdbcType=TIMESTAMP}, ",
        "#{userLevel,jdbcType=INTEGER}, #{accountMoney,jdbcType=DECIMAL}, ",
    ...
    @Select({
        "select",
        "`id`, `status`, `user_name`, `identity_card_type`, `identity_card_no`, `mobile`, ",
