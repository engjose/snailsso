...
public interface UserMapper {
    ...
    @Insert({
        ...
        "#{identityCardType,jdbcType=TINYINT}, #{identityCardNo,jdbcType=VARCHAR}, ",
        "#{mobile,jdbcType=INTEGER}, #{email,jdbcType=VARCHAR}, #{gender,jdbcType=CHAR}, ",
        "#{point,jdbcType=INTEGER}, #{registerTime,jdbcType=TIMESTAMP}, ",
        "#{birthday,jdbcType=TIMESTAMP}, #{userLevel,jdbcType=TINYINT}, ",
