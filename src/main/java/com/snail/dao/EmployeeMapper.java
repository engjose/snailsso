...
public interface EmployeeMapper {
     ...
     */
    @Insert({
        "insert into `employee` (`id`, `login_name`, ",
        "`password`, `name`, `level`, ",
        "`position`, `icon_url`, ",
    ...
    @Select({
        "select",
        "`id`, `login_name`, `password`, `name`, `level`, `position`, `icon_url`, `life_pic_url`, ",
        "`introduction`, `motto`, `mobile`, `email`, `gender`, `create_time`, `update_time`, ",
        "`status`",
        "from `employee`",
        "where `id` = #{id,jdbcType=INTEGER}"
    })
