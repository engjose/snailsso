...
public class User {
     ...
     * @mbggenerated
     */
    public User(Integer userId, String userName, Byte identityCardType, String identityCardNo, Integer mobile, String email, String gender, Integer point, Date registerTime, Date birthday, Byte userLevel, BigDecimal accountMoney, Date createTime, Date updateTime, String app) {
        this.userId = userId;
