...
public class User {
     ...
     * @mbggenerated
     */
    public User(Integer userId, String userName, Integer identityCardType, String identityCardNo, String mobile, String email, String gender, Integer point, Date registerTime, Date birthday, Integer userLevel, BigDecimal accountMoney, Date createTime, Date updateTime, String app, Integer status) {
        this.userId = userId;
