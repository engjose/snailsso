...
public class UserLogin {
     ...
     * @mbggenerated
     */
    public UserLogin(Integer id, Integer userId, String loginName, String password, Integer userStatus, Date createTime, Date updateTime, String userEmail, String userMobile) {
        this.id = id;
        this.userId = userId;
