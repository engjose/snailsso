...
public class Employee implements Serializable {
     ...
     * @mbggenerated
     */
    public Employee(Integer id, String loginName, String password, String name, Integer level, String position, String iconUrl, String lifePicUrl, String introduction, String motto, String mobile, String email, String gender, Date createTime, Date updateTime, Integer status) {
        this.id = id;
