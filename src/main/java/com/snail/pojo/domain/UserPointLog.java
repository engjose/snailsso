...
public class UserPointLog {
     ...
     * This field corresponds to the database column user_point_log.id
     *
     * @mbggenerated
     */
    private Integer id;
     ...
     * @mbggenerated
     */
    public UserPointLog(Integer id, Integer userId, Integer source, Integer transSerial, Integer changePint, Date createTime, Date updateTime, String app) {
        this.id = id;
        this.userId = userId;
        this.source = source;
    ...
    /**
     * This method was generated by MyBatis Generator.
     * This method returns the value of the database column user_point_log.id
     *
     * @return the value of user_point_log.id
     *
     * @mbggenerated
     */
    ...
    /**
     * This method was generated by MyBatis Generator.
     * This method sets the value of the database column user_point_log.id
     *
     * @param id the value for user_point_log.id
     *
     * @mbggenerated
     */
